...
public class PickImageFragment extends Fragment {
    ...
    private void clearTempImages() {
        try {
            File tempFolder = new File(String.valueOf(getContext().getExternalFilesDir("/scanner")));
        ...
        if (ContextCompat.checkSelfPermission(getActivity(), Manifest.permission.CAMERA) == PackageManager.PERMISSION_GRANTED) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                Uri tempFileUri = FileProvider.getUriForFile(getActivity().getApplicationContext(),
                        "com.example.cardwallet.Add_New_Card.provider", // As defined in Manifest
                        file);
    ...
    private File createImageFile() {
        ...
        File ur = new File(String.valueOf(getContext().getExternalFilesDir("/scanner")),"IMG_" + timeStamp + ".jpg");
        fileUri = Uri.fromFile(ur);
        return ur;
    }
